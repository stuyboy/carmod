...
var StoryPhotos = React.createClass({
    ...
    render: function () {
        return React.createElement(
            "div",
            { id: "storyPhotos" },
            this.data.photoUrls.map(function (p) {
            ...
            this.data.stories.map(function (c) {
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(StoryPhotos, { ref: "StoryPhotos", storyId: c.objectId, userId: c.author.objectId })
                    )
                );
            })
        );
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement("input", { type: "file", id: "imageFileUpload", ref: "file", onChange: this.changeHandler }),
