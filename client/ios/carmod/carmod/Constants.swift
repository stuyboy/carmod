...
// Font constants
let FONT_PRIMARY: String = "Arimo-Regular"
let FONT_BOLD: String = "Arimo-Bold"

let FONTSIZE_XLARGE: CGFloat = IS_IPHONE_4_OR_LESS ? 22.0 : IS_IPHONE_5_OR_LESS ? 22.0 : 22.0
let FONTSIZE_LARGE: CGFloat = IS_IPHONE_4_OR_LESS ? 16.0 : IS_IPHONE_5_OR_LESS ? 16.0 : 16.0
let FONTSIZE_STANDARD: CGFloat = IS_IPHONE_4_OR_LESS ? 15.0 : IS_IPHONE_5_OR_LESS ? 14.0 : 14.0
let FONTSIZE_MEDIUM: CGFloat = IS_IPHONE_4_OR_LESS ? 14.0 : IS_IPHONE_5_OR_LESS ? 12.0 : 12.0
let FONTSIZE_SMALL: CGFloat = IS_IPHONE_4_OR_LESS ? 12.0 : IS_IPHONE_5_OR_LESS ? 10.0 : 10.0
let FONTSIZE_XSMALL: CGFloat = IS_IPHONE_4_OR_LESS ? 9.0 : IS_IPHONE_5_OR_LESS ? 9.0 : 9.0
...
let TAG_ROW_HEIGHT: CGFloat = 40.0
