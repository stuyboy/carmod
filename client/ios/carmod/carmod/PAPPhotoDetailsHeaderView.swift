...
class PAPPhotoDetailsHeaderView: UIView {
  ...
  private func createView() {
    ...
    */
    self.photoImageView = PFImageView(frame: CGRectMake(mainImageX, mainImageY, self.frame.width, mainImageHeight))
    ...
    */
    self.nameHeaderView = UIView(frame: CGRectMake(nameHeaderX, nameHeaderY, self.frame.width, nameHeaderHeight))
    ...
    */
    likeBarView = UIView(frame: CGRectMake(likeBarX, likeBarY, self.frame.width, likeBarHeight))
