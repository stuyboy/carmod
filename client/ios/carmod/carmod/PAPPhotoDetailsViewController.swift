...
//
//class PAPPhotoDetailsViewController : PFQueryTableViewController, UITextFieldDelegate, StoryHeaderViewDelegate, PAPBaseTextCellDelegate {
...
//    
//    // Set table header
//    self.headerView = StoryHeaderView(frame: CGRect(x: 0.0, y: 0.0, width: self.view.bounds.size.width, height: HEADER_HEIGHT))
...
//    if self.currentUserOwnsStory() {
//      let deletePhotoAction = UIAlertAction(title: NSLocalizedString("Delete Story", comment: ""), style: UIAlertActionStyle.Destructive, handler: { _ in
//        // prompt to delete
//        self.showConfirmDeleteStoryActionSheet()
//      })
...
//  }
//  
//  func showConfirmDeleteStoryActionSheet() {
//    // prompt to delete
//    let actionController = UIAlertController(title: NSLocalizedString("Are you sure you want to delete this story?", comment: ""), message: nil, preferredStyle: UIAlertControllerStyle.ActionSheet)
//    let deleteAction = UIAlertAction(title: NSLocalizedString("Yes, delete story", comment: ""), style: UIAlertActionStyle.Destructive, handler: { _ in
//      self.shouldDeleteStory()
//    })
//    let cancelAction = UIAlertAction(title: NSLocalizedString("Cancel", comment: ""), style: UIAlertActionStyle.Cancel, handler: nil)
//    
...
//  }
//  
//  func currentUserOwnsStory() -> Bool {
//    return (self.story.objectForKey(kStoryAuthorKey) as! PFObject).objectId == PFUser.currentUser()!.objectId
//  }
//  
//  func shouldDeleteStory() {
//    // Delete all activites related to this photo
//    let query = PFQuery(className: kPAPActivityClassKey)
//    query.whereKey(kPAPActivityStoryKey, equalTo: self.story!)
...
//    }
//    
//    // Delete all photos and annotations related to this story
//
//    
//    
//    self.story!.deleteEventually()
