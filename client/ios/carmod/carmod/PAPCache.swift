...
final class PAPCache {
  ...
  func setAttributesForPhoto(photo: PFObject, likers: [PFUser], commenters: [PFUser], likedByCurrentUser: Bool, annotations: [PFObject]) {
    let attributes = [
  ...
  func setTagsForPhoto(photo: PFObject, annotations: [PFObject]) {
    ...
    if attributes == nil {
      ...
      attributes = [
        kPAPPhotoAttributesIsLikedByCurrentUserKey: isLikedByCurrentUser,
        kPAPPhotoAttributesLikeCountKey: likers.count,
        kPAPPhotoAttributesLikersKey: likers,
        kPAPPhotoAttributesCommentCountKey: commenters.count,
        kPhotoAttributesAnnotationsKey: annotations,
